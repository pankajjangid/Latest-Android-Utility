...
public final class EncryptUtils {
    ...
    public static String encryptMD5ToString(final byte[] data, final byte[] salt) {
        ...
        java.lang.System.arraycopy(data, 0, dataSalt, 0, data.length);
        java.lang.System.arraycopy(salt, 0, dataSalt, data.length, salt.length);
        ...
        try {
            ...
            if (count > 0) {
                ...
                for (int i = 0; i < count; i++) {
                    java.lang.System.arraycopy(data, index, buff, 0, maxLen);
                ...
                if (index != len) {
                    ...
                    java.lang.System.arraycopy(data, index, buff, 0, restLen);
                    ret = joins(ret, cipher.doFinal(buff));
                }
                return ret;
            } else {
    ...
    private static byte[] joins(final byte[] prefix, final byte[] suffix) {
        ...
        java.lang.System.arraycopy(prefix, 0, ret, 0, prefix.length);
        java.lang.System.arraycopy(suffix, 0, ret, prefix.length, suffix.length);
        return ret;
    }
