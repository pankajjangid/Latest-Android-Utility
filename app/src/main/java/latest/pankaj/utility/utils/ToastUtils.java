...
public final class ToastUtils {
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(MyApp.getApp().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(MyApp.getApp().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                final Toast toast = Toast.makeText(MyApp.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                final Toast toast = new Toast(MyApp.getApp());
                sWeakToast = new WeakReference<>(toast);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) MyApp.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
