...
public class GoogleUpdateChecker {
// How To Use IT

/*    Activity activity=this;
 new GoogleUpdateChecker(activity, false);
    ...
    Activity activity=this;
 new GoogleUpdateChecker("com.grisoft.umut.uBackup",activity, false);*/
    ...
    private static GoogleUpdateChecker mInstance;
    ...
    private static final String TAG = "GoogleUpdateChecker";
    private String appPackageName;
    private Context context;

    public GoogleUpdateChecker(final Activity activity, final Boolean haveNoButton) {
    ...
    public GoogleUpdateChecker(String packageName, final Activity activity, final Boolean haveNoButton) {
