package latest.pankaj.utility.show_case_view;
...
import latest.pankaj.utility.show_case_view.lib_flies.GuideView;


public class ShowCaseViewExampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_case_view_example);
        ...
        builder = new GuideView.Builder(ShowCaseViewExampleActivity.this)
