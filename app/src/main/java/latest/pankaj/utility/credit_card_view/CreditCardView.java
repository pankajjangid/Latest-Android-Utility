package latest.pankaj.utility.credit_card_view;/*
...
import latest.pankaj.utility.credit_card_view.util.AndroidUtils;

import static latest.pankaj.utility.credit_card_view.CardNumberFormat.ALL_DIGITS;
import static latest.pankaj.utility.credit_card_view.CardNumberFormat.MASKED_ALL;
import static latest.pankaj.utility.credit_card_view.CardNumberFormat.MASKED_ALL_BUT_LAST_FOUR;
import static latest.pankaj.utility.credit_card_view.CardNumberFormat.ONLY_LAST_FOUR;
import static latest.pankaj.utility.credit_card_view.CardType.AMERICAN_EXPRESS;
import static latest.pankaj.utility.credit_card_view.CardType.AUTO;
import static latest.pankaj.utility.credit_card_view.CardType.DISCOVER;
import static latest.pankaj.utility.credit_card_view.CardType.MASTERCARD;
import static latest.pankaj.utility.credit_card_view.CardType.PATTERN_AMERICAN_EXPRESS;
import static latest.pankaj.utility.credit_card_view.CardType.PATTERN_DISCOVER;
import static latest.pankaj.utility.credit_card_view.CardType.PATTERN_MASTER_CARD;
import static latest.pankaj.utility.credit_card_view.CardType.VISA;
...
public class CreditCardView extends RelativeLayout {
    ...
    private void rotateInToBackBeforeEleven() {
        AnimatorSet set = new AnimatorSet();
       ObjectAnimator rotateIn = ObjectAnimator.ofFloat(this, "rotationY", 0, 90);
       ObjectAnimator hideFrontView =ObjectAnimator.ofFloat(this, "alpha", 1, 0);
        rotateIn.setInterpolator(new AccelerateDecelerateInterpolator());
        rotateIn.setDuration(300);
        hideFrontView.setDuration(1);
        set.addListener(new Animator.AnimatorListener() {
