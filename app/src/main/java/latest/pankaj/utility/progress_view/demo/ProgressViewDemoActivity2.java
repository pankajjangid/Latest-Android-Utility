...
public class ProgressViewDemoActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_progress_view_demo_2);
...
//                mCircleProgressFillIn.setRadius(progress == 0 ? 20 : progress / 6 + 20);
    ...
    public void toMainActivity(View view) {
        startActivity(new Intent(this, ProgressViewDemoActivity1.class));
    }
